<nav x-data="{ open: false }" class="bg-red-700 border-b border-gray-100 dark:border-gray-700">
    @if (Auth::check())
                ...
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('dashboard') }}">
                            <x-jurassic-park.application-logo-black
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('superuser')" :active="request()->routeIs('superuser')">
                            {{ __('Super User') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dinosaurs')" :active="request()->routeIs('dinosaurs')">
                            {{ __('Dinosaurs') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dinosaurs')" :active="request()->routeIs('dinosaurs')">
                            {{ __('Dinosaurs') }}
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        ...
                        @if (Route::has('login'))
                            <div class="  sm:fixed sm:top-0 sm:right-80 p-6 text-right">
                                @auth
